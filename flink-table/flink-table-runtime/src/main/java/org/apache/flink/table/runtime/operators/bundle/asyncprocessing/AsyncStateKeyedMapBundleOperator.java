...
/**
 * The {@link AsyncStateKeyedMapBundleOperator} uses framework's key as bundle map key, thus can only be used
 * on {@link org.apache.flink.streaming.api.datastream.KeyedStream}.
 */
public class AsyncStateKeyedMapBundleOperator<K, V, IN, OUT>
        extends AbstractAsyncStateMapBundleOperator<K, V, IN, OUT> {

    private static final long serialVersionUID = 1L;

    public AsyncStateKeyedMapBundleOperator(
